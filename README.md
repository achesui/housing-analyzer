...
Una implementación simple de una red neuronal en Rust para predecir precios de casas.
...
- implementar capas ocultas para convertirlo en un Perceptrón Multicapa capaz de aprender patrones no lineales
